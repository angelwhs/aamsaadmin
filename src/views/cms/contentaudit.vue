                ...
                <v-card class="mx-auto">
                    <v-row class="mx-auto">
                        <v-col cols="12" md="8" class="d-flex justify-center align-center">
                            <v-text-field class="subtitle-2 ml-4 mt-3" dense v-model="searchModel.searchName" label="搜索条件" hide-details
                                placeholder="请输入搜索条件">
                            </v-text-field>
                        </v-col>
                        <v-col cols="12" md="2" class="d-flex justify-center align-center">
                            <v-select class="mt-3" :items="contentTypeList" dense label="内容类型" item-text="Name" item-value="Id" hide-details
                                placeholder="请选择内容类型" v-model="searchModel.contentType">
                            </v-select>
                        </v-col>
                        <v-col cols="12" md="2" class="d-flex justify-center align-center">
                            <v-btn class="align-center mt-3" @click="search(0)">搜索</v-btn>
                        </v-col>
                    </v-row>
                </v-card>
            </div>
