                    ...
                    <v-row class="mx-auto ">
                        <v-col>
                            <v-select hide-details :items="schoolSelector.list" item-text="Title" item-value="Id"
                                label="选择学校" return-object v-model="schoolSelector.selected"
    ...
    export default {
        ...
        methods: {
            search: function (pageIndex) {
                ...
                this.getAxios('/api/aa/backend/grades/list', {
            ...
            saveUpdate: function () {
                ...
                if (this.updateItem.Id === 0) {
                    this.postAxios('/api/aa/backend/grades/create', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                    ...
                    this.postAxios('/api/aa/backend/grades/edit', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                            this.updateDialog.isShow = false;
            ...
            saveDelete: function () {
                ...
                this.getAxios('/api/aa/backend/grades/delete', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
            ...
            saveSetEnable: function () {
                ...
                this.getAxios('/api/aa/backend/grades/setenable', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
