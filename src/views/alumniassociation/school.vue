                ...
                <v-card ref="form">
                    ...
                    <v-card-text>
                        <v-container>
                            <v-row>
                                <v-col cols="12" md="9">
                                    <v-text-field v-model="updateItem.Title" dense label="名称" placeholder="请输入学校名称"
                            ...
                            <v-subheader class="mt-3">学校简介</v-subheader>
                                <v-divider></v-divider>
                            <v-row>
                                <v-col cols="12" md="12">
    ...
    export default {
        ...
        methods: {
            search: function (pageIndex) {
                ...
                this.getAxios('/api/aa/backend/school/list', {
            ...
            saveUpdate: function () {
                ...
                if (this.updateItem.Id === 0) {
                    this.postAxios('/api/aa/backend/school/create', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                    ...
                    this.postAxios('/api/aa/backend/school/edit', JSON.stringify(this.updateItem)).then((data) => {
                        if (data.errorcode === 0) {
                            this.loadingDialog.isShow = false;
                            this.updateDialog.isShow = false;
            ...
            saveDelete: function () {
                ...
                this.getAxios('/api/aa/backend/school/delete', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
            ...
            saveSetEnable: function () {
                ...
                this.getAxios('/api/aa/backend/school/setenable', { id: this.updateItem.Id, }).then((data) => {
                    if (data.errorcode === 0) {
                        this.loadingDialog.isShow = false;
